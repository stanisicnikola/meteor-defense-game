...
bg = pygame.image.load('pictures/starbg.png')
alienImg = pygame.image.load('pictures/alienShip.png')
playerRocket = pygame.image.load('pictures/spaceRocket.png')
star = pygame.image.load('pictures/star.png')
asteroid50 = pygame.image.load('pictures/asteroid50.png')
asteroid100 = pygame.image.load('pictures/asteroid100.png')
asteroid150 = pygame.image.load('pictures/asteroid150.png')
...
class AlienBullet(object):
    ...
    def draw(self, win):
        pygame.draw.rect(win, (204, 204, 0), [self.x, self.y, self.w, self.h])
